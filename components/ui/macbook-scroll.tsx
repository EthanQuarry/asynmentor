...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 2], [0, 1500]);
  ...
  return (
    <div
      ref={ref}
      className="md:min-h-[200vh] min-h-[100vh] flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
      ...
      >
        {title || (
          <span>
            Compete against other students and shi. <br /> No kidding.
          </span>
        )}
      </motion.h2>
      {/* Lid */}
